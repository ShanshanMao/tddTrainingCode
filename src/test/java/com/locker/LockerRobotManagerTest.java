...
public class LockerRobotManagerTest {
    ...
    public void should_return_a_ticket_and_store_in_1st_locker_when_LockerRobotManager_have_2_locker_with_available_capacity_and_no_robot() {
        ...
        Assert.assertTrue(firstLocker.containsBag(myBag));
    }
    ...
    public void should_return_a_ticket_and_store_in_2nd_locker_when_LockerRobotManager_have_1_full_locker_1_available_capacity_locker_and_no_robot() {
        ...
        Ticket ticket = lockerRobotManager.store(myBag);
        Assert.assertNotNull(ticket);
        Assert.assertTrue(secondLocker.containsBag(myBag));
    }
    ...
    public void should_return_a_ticket_and_store_in_1st_robot_when_LockerRobotManager_have_2_robot_with_available_capacity_but_no_locker() {
        ...
        Ticket ticket = lockerRobotManager.store(myBag);
        Assert.assertNotNull(ticket);
        Assert.assertTrue(primaryLockerRobot.containsBag(myBag));
    }
    ...
    public void should_return_a_ticket_and_store_in_2nd_robot_when_LockerRobotManager_have_1st_full_robot_and_2nd_robot_with_available_capacity_but_no_locker() {
        ...
        Ticket ticket = lockerRobotManager.store(myBag);
        Assert.assertNotNull(ticket);
        Assert.assertTrue(smartLockerRobot.containsBag(myBag));
    }
    ...
    public void should_return_a_ticket_when_LockerRobotManager_have_1_robot_and_1_locker_both_have_available_capacity() {
        ...
        Ticket ticket = lockerRobotManager.store(myBag);
        Assert.assertNotNull(ticket);
        Assert.assertTrue(lockerRobot.containsBag(myBag));
    }
    ...
    public void should_return_a_ticket_and_store_in_locker_when_LockerRobotManager_have_1_full_robot_and_1_locker_have_available_capacity() {
        ...
        Ticket ticket = lockerRobotManager.store(myBag);
        Assert.assertNotNull(ticket);
        Assert.assertTrue(locker.containsBag(myBag));
    }
    ...
    @Test
    public void should_return_bag_when_pickUp_bag_with_valid_ticket_and_LockerRobotManager_have_no_locker_but_2_robot_with_available_capacity() {
    ...
    @Test
    public void should_return_when_pickUp_bag_with_valid_ticket_and_LockerRobotManager_have_1_locker_and_1_robot() {
        PrimaryLockerRobot primaryLockerRobot = new PrimaryLockerRobot(Collections.singletonList(new Locker(1)));
        Locker locker = new Locker(1);
    ...
    @Test(expected = InvalidTicketException.class)
    public void should_return_InvalidTicketException_when_pickUp_bag_with_inValid_ticket_and_LockerRobotManager_have_1_locker_and_1_robot() {
        PrimaryLockerRobot primaryLockerRobot = new PrimaryLockerRobot(Collections.singletonList(new Locker(1)));
        Locker locker = new Locker(1);
        LockerRobotManager lockerRobotManager = new LockerRobotManager(Collections.singletonList(locker), Collections.singletonList(primaryLockerRobot));
        lockerRobotManager.store(new Bag());
    ...
    @Test(expected = InvalidTicketException.class)
    public void should_return_InvalidTicketException_when_store_bag_via_LockerRobotManager_but_pickUp_from_PrimaryLockerRobot(){
        PrimaryLockerRobot primaryLockerRobot = new PrimaryLockerRobot(Collections.singletonList(new Locker(1)));
        Locker locker = new Locker(1);
        LockerRobotManager lockerRobotManager = new LockerRobotManager(Collections.singletonList(locker), Collections.singletonList(primaryLockerRobot));
